...
impl k8s_openapi::DeepMerge for SubnetReference {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for SubnetReference {
...
impl k8s_openapi::serde::Serialize for SubnetReference {
