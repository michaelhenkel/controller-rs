...
impl k8s_openapi::DeepMerge for ResourceReference {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for ResourceReference {
...
impl k8s_openapi::serde::Serialize for ResourceReference {
