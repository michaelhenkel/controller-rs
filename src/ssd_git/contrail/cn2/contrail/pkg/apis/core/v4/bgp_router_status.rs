...
impl k8s_openapi::DeepMerge for BGPRouterStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for BGPRouterStatus {
...
impl k8s_openapi::serde::Serialize for BGPRouterStatus {
