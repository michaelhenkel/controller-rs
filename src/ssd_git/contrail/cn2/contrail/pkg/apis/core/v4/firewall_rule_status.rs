...
impl k8s_openapi::DeepMerge for FirewallRuleStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for FirewallRuleStatus {
...
impl k8s_openapi::serde::Serialize for FirewallRuleStatus {
