...
impl k8s_openapi::DeepMerge for ContrailSecurityPolicySpec {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for ContrailSecurityPolicySpec {
...
impl k8s_openapi::serde::Serialize for ContrailSecurityPolicySpec {
