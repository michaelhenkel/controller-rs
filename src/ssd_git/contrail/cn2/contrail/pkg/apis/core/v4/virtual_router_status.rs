...
impl k8s_openapi::DeepMerge for VirtualRouterStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for VirtualRouterStatus {
...
impl k8s_openapi::serde::Serialize for VirtualRouterStatus {
