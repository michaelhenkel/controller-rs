...
impl k8s_openapi::DeepMerge for RouteTargetSpec {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
    }
}

impl<'de> k8s_openapi::serde::Deserialize<'de> for RouteTargetSpec {
...
impl k8s_openapi::serde::Serialize for RouteTargetSpec {
