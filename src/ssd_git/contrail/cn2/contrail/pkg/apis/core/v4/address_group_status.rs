...
impl k8s_openapi::DeepMerge for AddressGroupStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for AddressGroupStatus {
...
impl k8s_openapi::serde::Serialize for AddressGroupStatus {
