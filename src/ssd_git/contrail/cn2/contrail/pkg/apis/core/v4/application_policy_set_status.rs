...
impl k8s_openapi::DeepMerge for ApplicationPolicySetStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for ApplicationPolicySetStatus {
...
impl k8s_openapi::serde::Serialize for ApplicationPolicySetStatus {
