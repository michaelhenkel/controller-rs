...
impl k8s_openapi::DeepMerge for VirtualNetworkReference {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for VirtualNetworkReference {
...
impl k8s_openapi::serde::Serialize for VirtualNetworkReference {
