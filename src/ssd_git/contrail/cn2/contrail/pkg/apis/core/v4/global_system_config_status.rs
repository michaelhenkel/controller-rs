...
impl k8s_openapi::DeepMerge for GlobalSystemConfigStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for GlobalSystemConfigStatus {
...
impl k8s_openapi::serde::Serialize for GlobalSystemConfigStatus {
