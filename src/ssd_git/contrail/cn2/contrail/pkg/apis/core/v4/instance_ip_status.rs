...
impl k8s_openapi::DeepMerge for InstanceIPStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for InstanceIPStatus {
...
impl k8s_openapi::serde::Serialize for InstanceIPStatus {
