...
impl k8s_openapi::DeepMerge for ContrailSecurityPolicyStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for ContrailSecurityPolicyStatus {
...
impl k8s_openapi::serde::Serialize for ContrailSecurityPolicyStatus {
