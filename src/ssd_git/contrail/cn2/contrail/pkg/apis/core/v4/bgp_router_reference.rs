...
impl k8s_openapi::DeepMerge for BGPRouterReference {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for BGPRouterReference {
...
impl k8s_openapi::serde::Serialize for BGPRouterReference {
