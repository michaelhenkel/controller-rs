...
impl k8s_openapi::DeepMerge for RouteTableType {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi::merge_strategies::list::atomic(&mut self.route, other.route);
    }
}

impl<'de> k8s_openapi::serde::Deserialize<'de> for RouteTableType {
...
impl k8s_openapi::serde::Serialize for RouteTableType {
