...
impl k8s_openapi::DeepMerge for GlobalContrailSecurityPolicyStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for GlobalContrailSecurityPolicyStatus {
...
impl k8s_openapi::serde::Serialize for GlobalContrailSecurityPolicyStatus {
