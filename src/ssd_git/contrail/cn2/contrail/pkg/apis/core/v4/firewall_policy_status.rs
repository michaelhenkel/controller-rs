...
impl k8s_openapi::DeepMerge for FirewallPolicyStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for FirewallPolicyStatus {
...
impl k8s_openapi::serde::Serialize for FirewallPolicyStatus {
