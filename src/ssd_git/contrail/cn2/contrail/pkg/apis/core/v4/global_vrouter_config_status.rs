...
impl k8s_openapi::DeepMerge for GlobalVrouterConfigStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for GlobalVrouterConfigStatus {
...
impl k8s_openapi::serde::Serialize for GlobalVrouterConfigStatus {
