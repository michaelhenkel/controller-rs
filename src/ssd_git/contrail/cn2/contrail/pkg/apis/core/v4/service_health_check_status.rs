...
impl k8s_openapi::DeepMerge for ServiceHealthCheckStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for ServiceHealthCheckStatus {
...
impl k8s_openapi::serde::Serialize for ServiceHealthCheckStatus {
