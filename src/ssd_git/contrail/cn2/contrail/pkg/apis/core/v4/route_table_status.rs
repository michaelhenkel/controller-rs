...
impl k8s_openapi::DeepMerge for RouteTableStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for RouteTableStatus {
...
impl k8s_openapi::serde::Serialize for RouteTableStatus {
