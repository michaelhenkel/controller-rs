...
impl k8s_openapi::DeepMerge for RouteTargetStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for RouteTargetStatus {
...
impl k8s_openapi::serde::Serialize for RouteTargetStatus {
