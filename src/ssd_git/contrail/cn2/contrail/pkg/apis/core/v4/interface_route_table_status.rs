...
impl k8s_openapi::DeepMerge for InterfaceRouteTableStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for InterfaceRouteTableStatus {
...
impl k8s_openapi::serde::Serialize for InterfaceRouteTableStatus {
