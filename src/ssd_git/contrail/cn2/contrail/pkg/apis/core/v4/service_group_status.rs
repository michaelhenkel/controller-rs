...
impl k8s_openapi::DeepMerge for ServiceGroupStatus {
...
impl<'de> k8s_openapi::serde::Deserialize<'de> for ServiceGroupStatus {
...
impl k8s_openapi::serde::Serialize for ServiceGroupStatus {
